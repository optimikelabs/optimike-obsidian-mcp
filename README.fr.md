...
- Plugins :
  ...
  - Kairélys `2.6.1`, ou une release Operon compatible avec Public API v1, et Optimike Operon Bridge (requis pour les mutations live ; Bridge inclus dans ce repo)
