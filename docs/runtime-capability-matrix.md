...
| Native semantic note links          | Yes, public MetadataCache | Yes while Desktop API is live           | No                       | No                      | No                               | No                                                                        |
...
runtime availability: official Operon `3.9.3` retains saved-filter evaluation,
