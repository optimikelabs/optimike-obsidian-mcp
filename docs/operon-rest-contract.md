...
- Bridge contract: `1`
- Latest tested compatible engine version: Kairélys `2.6.1`
- Official Operon read allowlist: `2.4.0`, `2.5.0`
- Kairélys read allowlist: `2.5.1`, `2.5.2`, `2.5.3`, `2.6.1`
- Mutation contract: Operon Public API `1`
- Official Operon `2.5.0`: read-only
- Kairélys `2.5.1` through `2.5.3` and `2.6.1` with Public API v1: read-write
