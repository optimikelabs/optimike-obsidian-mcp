...
révoquée. Operon `3.6.2` rend canonique l’ordre des ressources d’un plan scellé
avec une comparaison des unités de code UTF-16 indépendante de la locale ; Pilot 2
