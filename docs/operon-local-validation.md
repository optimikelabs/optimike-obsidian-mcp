...
- Optimike MCP `3.9.0`, targeting Operon `3.6.2`, Operon CLI `1.2.0` and Local REST API `5.1.0` behind the exact-SHA release gate below; `3.8.2` remains the published baseline until promotion, `3.2.1` remains in the explicit certified set, `3.3.2` / CLI `1.1.2` remains completed historical evidence, and `2.4.0` / `2.5.0` remain legacy-read fixtures
...
$env:OPERON_35_CANARY_EXPECTED_MCP_VERSION = "3.9.0"
