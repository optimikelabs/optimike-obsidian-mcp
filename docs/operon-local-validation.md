...
The adapter explicitly certifies Operon `3.9.3` and gives later non-denied V1
...
- official Operon `3.9.3` reports the exact Developer API V1 and additive
...
- official Operon `3.9.3` exposes mutations after Developer API V1 negotiation,
...
target, Operon `3.9.3`; set the explicit variable above so copied acceptance
