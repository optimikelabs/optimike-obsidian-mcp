...
| Liens sémantiques natifs d’une note           | Oui, `MetadataCache` public  | Oui tant que l’API Desktop est live        | Non                       | Non                             | Non                                 | Non                                                                        |
...
garantit pas la disponibilité runtime : Operon officiel `3.9.3` conserve
