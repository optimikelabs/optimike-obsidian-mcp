...
digests P0 historiques restent inchangés.
...
complexes ou quotées, syntaxe multi-document, entrées ciblées contenant des
scalaires de bloc directs ou imbriqués ou des scalaires quotés multilignes,
