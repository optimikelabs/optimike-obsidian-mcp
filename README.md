...
The MCP does not generically relay CLIs. Public mutations need a bounded schema,
least privilege, preconditions, durable idempotency, postflight proof, and exact
recovery where the backend can enforce them.
