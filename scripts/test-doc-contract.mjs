...
assert.match(
  operonLocalValidation,
  /OPERON_35_CANARY_EXPECTED_BRIDGE_VERSION = "0\.9\.3"/u,
...
for (const content of [operonContract, operonAudit]) {
  ...
  assert.match(content, /Bridge\s+`0\.9\.3`/u);
